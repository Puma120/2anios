...
var stemVarsFrom = { scaleY: 0, transformOrigin: "bottom", autoAlpha: 1 };
var stemVarsTo = { scaleY: 1, duration:2, stagger:0.5 };
...
.fromTo( ['#Stem16_1_','#Stem1_1_'], {scaleY: 0, transformOrigin: "bottom" }, {duration:1.5, scaleY: 1 }, 'start')
...
.fromTo( ['#Stem9_1_','#Stem25_1_'], {scaleY: 0, transformOrigin: "bottom",  autoAlpha: 1 }, {duration:2, scaleY: 1 }, 'flower1+=0.5')
...
//strokes
.fromTo(strokesLeftBottom, stemVarsFrom, { scaleY: 1, duration:2, stagger:1 }, 1)
.fromTo(strokesRightBottom, stemVarsFrom, { scaleY: 1, duration:2, stagger:1 }, 1)
.fromTo(strokesLeftTop, stemVarsFrom, { scaleY: 1, duration:2, stagger:1 }, 'flower1+=0.5')
.fromTo(strokesRightTop, stemVarsFrom, { scaleY: 1, duration:2, stagger:1 }, 'flower1+=0.5')
